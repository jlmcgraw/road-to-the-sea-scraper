...
from road_to_the_sea_scraper.version import (
    __version__,
    get_version,
...
def test_get_version__uses_pyproject() -> None:
    ...
    with (
        mock.patch(
            "road_to_the_sea_scraper.version.get_version_from_metadata",
            side_effect=PackageNotFoundError,
        ) as mocked_metadata,
        mock.patch(
            "road_to_the_sea_scraper.version.get_version_from_pyproject",
